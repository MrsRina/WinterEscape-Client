...
object EventBus {
    ...
    fun register(obj: Any) {
        ...
        val listenerMethods = clazz.declaredMethods.filter { it.isAnnotationPresent(EventListener::class.java) && it.parameterCount == 1 }
        ...
        listenerMethods.forEach { method ->
            ...
            if (anySuperclassIsEvent(type)) {
                ...
                invocations.getOrPut(type, { mutableListOf() }).add(Invocation(method, obj, annotation.priority, annotation.state))
